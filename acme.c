...
iconinit(void)
{
	...
	if(tagcols[BACK] == nil) {
		/* Blue */
		tagcols[BACK] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x565656ff);
		tagcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DPalegreygreen);
		tagcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DPurpleblue);
		tagcols[TEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xcdaa7dff);
		tagcols[HTEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xcdaa7dff);

		/* Yellow */
		textcols[BACK] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x161616ff);
		textcols[HIGH] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0x0000aaff);
		textcols[BORD] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, DYellowgreen);
		textcols[TEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xcdaa7dff);
		textcols[HTEXT] = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xcdaa7dff);
	}
