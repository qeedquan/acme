...
void xfrinit(Frame *f, Rectangle r, Font *ft, Image *b, Image *cols[NCOL]);
...
texttype(Text *t, Rune r)
{
	...
	case 0x11: /* Ctrl^Left */
		typecommit(t);
		nnb = textbswidth(t, 0x17);
		if (t->q0-nnb >= 0)
			textshow(t, t->q0-nnb, t->q0-nnb, TRUE);
		return;		
	case 0x12: /* Ctrl^Right */
		typecommit(t);
		q0 = t->q0;
		nb = nnb = 0;	
		while(q0<t->file->b.nc) {
			Rune c = textreadc(t, q0);
	...
	case 0x05:	/* ^E: end of line */
		...
		textshow(t, q0, q0, TRUE);
		return;
	case Kcmd+'c': case 0x03:	/* %C: copy */
		typecommit(t);
		cut(t, t, nil, TRUE, FALSE, nil, 0);
		return;
	case Kcmd+'s':	case 0x13: /* %S: save */
		typecommit(t);
		put(t, nil, nil, 0, 0, nil, 0);
		return;
	case Kcmd+'z':	case 0x1a:/* %Z: undo */
	 	typecommit(t);
		undo(t, nil, nil, TRUE, 0, nil, 0);
		return;
	case Kcmd+'Z': case 0x19: /* %-shift-Z: redo */
	 	typecommit(t);
